...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.scss */ \"./src/style.scss\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_show_show_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/show/show.js */ \"./src/modules/show/show.js\");\n/* harmony import */ var _modules_store_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/store.js */ \"./src/modules/store.js\");\n/* harmony import */ var _modules_show_commentPopup_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show/commentPopup.js */ \"./src/modules/show/commentPopup.js\");\n/* eslint-disable arrow-parens */\n\n\n\n\n\n\n(async () => {\n  const store = new _modules_store_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"]();\n  document.querySelector('.content').innerHTML = (await store.shows).map(v => (new _modules_show_show_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](v)).render()).join('');\n})();\n\ndocument.addEventListener('click', (event) => {\n  if (event.target.classList.contains('commentsButton')) {\n    const selectedItem = event.target.dataset.id;\n    const commentsPopup = new _modules_show_commentPopup_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](selectedItem);\n    commentsPopup.loadPopup();\n  }\n  console.log('clicked');\n});\ndocument.addEventListener('click', (event) => {\n  if (event.target.classList.contains('close-button')) {\n    const popupContainer = event.target.closest('.popup-container');\n    popupContainer.remove();\n  }\n  console.log('hello clicked');\n});\n\n\n//# sourceURL=webpack://webapp-api/./src/index.js?");
